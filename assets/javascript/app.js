...
$(document).ready(function(){
	...
	function timeUp(){
		...
		else if(Q7 == "Strategic Homeland Intervention Enforcement and Logistics Division"){
			correctCount++;
		}
		else{
			wrongCount++;
